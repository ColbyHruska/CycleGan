from keras.layers import Input, Dropout, Concatenate, LeakyReLU, LayerNormalization, UpSampling2D, Conv2D
from keras.models import Model
from keras.losses import MSE, BCE, MAE
...
class CycleGAN():
    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
        ...
        for epoch in range(epochs):
            for batch_i, (imgs_A, imgs_B) in enumerate(self.data_loader.load_batches(batch_size)):
